...
namespace SMPS.API.Controllers
{
    ...
    public class StudentAuthController : ControllerBase
    {
        ...
        {
            if (await _students.ExistsByEmailAsync(req.Email))
            ...
            return Ok(new AuthResponse(token, student.Email, "Student"));
        }
        ...
        {
            var student = await _students.GetByEmailAsync(req.Email);
